...
fun MiniMusicTheme(
    ...
    // Published here so every screen branches to its reduced path from one
    // source; see ReducedMotion.kt.
    val reducedMotion = rememberMiniMusicReducedMotion()

    CompositionLocalProvider(LocalMiniMusicReducedMotion provides reducedMotion) {
